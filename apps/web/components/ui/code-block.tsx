...
export function CodeBlock({
  ...
  const lang = language ?? (filename ? getLanguageFromFilename(filename) : "text");
  ...
  if (isDark === null) {
    return (
      <div className={cn("relative rounded-lg border border-border overflow-hidden bg-muted animate-pulse", className)}>
        {filename && (
